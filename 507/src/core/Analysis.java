	...
	public int[] tpfp(){
		...
		for(int i = 0; i< this.matches.size(); i++){
			...
			if(srcReturnType.equals(libReturnType) && srcParams.size() == libParams.size()){
				if(srcName.contains("absoluteValue") && 
					libName.equals("abs")){
					trueMatch = true;
				}
				else if(srcName.contains("maximum") && 
					libName.equals("max")){
					trueMatch = true;
				}
				else if(srcName.contains("minimum") && 
					libName.equals("min")){
					trueMatch = true;
				}
				else if(srcName.contains("power") && 
					libName.equals("pow")){
					trueMatch = true;
				}
				else if(srcName.contains("swap") && 
					libName.equals("swap")){
					trueMatch = true;
				}
					...
					libName.equals("copyOf")){
					trueMatch = true;
				}
				else if(srcName.contains("returnCopyRange") && 
					libName.equals("copyOfRange")){
					trueMatch = true;
				}
				else if(srcName.contains("convertToList") && 
					libName.equals("asList")){
					trueMatch = true;
				}
