...
import jgrapht.*;
import jgrapht.graph.specifics.*;
import jgrapht.util.*;

/**
 * The most general implementation of the {@link jgrapht.Graph} interface. Its
 * subclasses add various restrictions to get more specific graphs. The decision
 * whether it is directed or undirected is decided at construction time and
 * cannot be later modified (see constructor for details).
 *
 * <p>
...
public abstract class AbstractBaseGraph<V, E> extends AbstractGraph<V, E>
	 ...
	 *             in case the clone is not supported
	 *
	 ...
	 *
	 * @param vertex
	 *            vertex whose in degree is to be calculated.
	 ...
	 *
	 * @param vertex
	 *            vertex whose out degree is to be calculated
